...
namespace Rikrop.Core.Data.Unity
{
    ...
    internal static class TypeExtensions
    {
        ...
        public static Type[] GetGenericTypeArguments(this Type type, Type baseType)
        {
            ...
            var baseTypes = new List<Type>(GetBaseTypes(type, baseType, false));
            ...
            return baseTypes.Single().GetGenericArguments();
        }
        ...
        /// <returns></returns>
        private static IEnumerable<Type> GetBaseTypes(Type type, Type baseType, bool concreteGenericTypes)
        {
